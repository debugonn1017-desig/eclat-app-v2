...
//
//   v6 (2026-05-12) で 3 つ追加:
//     - 顧客.全店分析       : /admin/customer-analysis 閲覧 + 来店予測
//     - レポート.全店ビュー : 全キャスト本指名 Excel 等の横断ビュー
//     - 通知.自動配信設定   : ノルマ達成 Push の自動オン/オフ設定
...
export type StaffPermission =
  ...
  | 'レポート.全店ビュー'          // v6: 全キャスト本指名 Excel 等の横断ビュー
  // 🔔 通知系
  | '通知.送信'                    // カスタム通知の送信
  | '通知.自動配信設定'            // v6: ノルマ達成自動 Push のオン/オフ
...
export const PERMISSION_INCLUDES: Record<string, string[]> = {
  ...
  'お知らせ.投稿': ['お知らせ.閲覧'],
  'レポート.出力': ['レポート.閲覧'],
  'レポート.全店ビュー': ['レポート.閲覧'],    // v6: 全店ビューは閲覧を含む
}
...
export const PERMISSION_GROUPS: Array<{
  ...
  { category: 'レポート', emoji: '📑', permissions: ['レポート.閲覧', 'レポート.出力', 'レポート.全店ビュー'] },
  { category: '通知', emoji: '🔔', permissions: ['通知.送信', '通知.自動配信設定'] },
